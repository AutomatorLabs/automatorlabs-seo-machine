...
export const calculatorConfigs: Record<string, CalculatorConfig> = {
  ...
  'employer-match': {
    ...
    inputs: [
      ...
      { id: 'match-employee-percent', name: 'employeeContributionPercent', label: 'Employee contribution rate (%)', type: 'number', value: '6', min: '0', step: '0.01', required: true },
