...
function createRecord(
  ...
  return {
    ...
    question: `Monthly Car Savings for ${money(goalAmount)} ${purposeLabel} in ${years} ${years === 1 ? 'Year' : 'Years'} With ${money(currentSavings)} Already Saved at ${formatRate(annualReturnPercent)}%`,
    intent,
    goalAmount,
    currentSavings,
    years,
