...
function createRecord(
  ...
  return {
    ...
    question: `Monthly Savings Plan for ${money(goalAmount)} ${capitalizeWords(purposeLabel)} in ${years} ${years === 1 ? 'Year' : 'Years'} With ${money(currentSavings)} Already Saved at ${formatRate(annualReturnPercent)}%`,
    intent,
    goalAmount,
    currentSavings,
    years,
