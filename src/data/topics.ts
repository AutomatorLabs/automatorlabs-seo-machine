...
export const topics: TopicSection[] = [
  ...
  },
  {
    ...
    examples: [
      ...
      { title: 'Mortgage Recast Examples', url: '/calculators/mortgage-recast/examples/' },
      { title: 'Property Tax Examples', url: '/calculators/property-tax/examples/' },
      { title: 'Closing Cost Examples', url: '/calculators/closing-cost/examples/' },
    ],
  },
  {
    title: 'Debt',
    ...
    examples: [
      ...
      { title: 'Credit Card Interest Examples', url: '/calculators/credit-card-interest/examples/' },
      { title: 'Credit Card Minimum Payment Examples', url: '/calculators/credit-card-minimum-payment/examples/' },
      { title: 'Credit Card Extra Payment Examples', url: '/calculators/credit-card-extra-payment/examples/' },
